...
# Vermouth Build Script
# Builds the vermouth CLI tool for multiple platforms
...
# Get version using our own vermouth.sh (bootstrapping!)
...
for PLATFORM in "${PLATFORMS[@]}"; do
    ...
    OUTPUT_NAME="vermouth-${VERSION}-${GOOS}-${GOARCH}"
